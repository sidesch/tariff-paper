...
********************************************************************************
* 03_analysis.do
* Purpose: All figures, summary statistics, and regressions
* Input:   data/clean/enoe_merged.dta
*          data/clean/tariffs_by_scian3.dta
* Output:  output/ (figures and tables)
* Notes:   ENOE is a repeated cross-section; individuals are not tracked
*          across years. All quarters used (2014-2020, Q2 2020 missing).
********************************************************************************

********************************************************************************
* PRELIMINARY: Prepare analysis variables
********************************************************************************
...
* Generate analysis variables (log_income already exists but regenerate cleanly)
cap drop log_income
